...
class SearchPagesServiceTests: XCTestCase {
    ...
    func testThat_whenStartSearchIsCalled_withAnEmptyTerm_itImmediatelyReturnsAnInvalidParameterError() {
        let params = SearchParameters(term: "", states: ["Alabama", "Colorado"], earliestDayMonthYear: SearchConstants.earliestPossibleDayMonthYear, latestDayMonthYear: SearchConstants.latestPossibleDayMonthYear)
    ...
    func testThat_whenStartSearchIsCalled_withValidParameters_itStartsARequest_withTheCorrectTerm() {
        let params = SearchParameters(term: "tsunami wave", states: ["Alabama", "Colorado"], earliestDayMonthYear: SearchConstants.earliestPossibleDayMonthYear, latestDayMonthYear: SearchConstants.latestPossibleDayMonthYear)
    ...
    func testThat_whenStartSearchIsCalled_withValidParameters_itStartsARequest_withTheCorrectStates() {
        let params = SearchParameters(term: "tsunami", states: ["New York", "Colorado"], earliestDayMonthYear: SearchConstants.earliestPossibleDayMonthYear, latestDayMonthYear: SearchConstants.latestPossibleDayMonthYear)
        subject.startSearch(params, page: 4, contextID: "context") { _, _ in }
    ...
    func testThat_whenCancelSearchIsCalled_withParametersThatDoNotMatchAnActiveRequest_itDoesNotCancelsTheActiveRequest() {
        let activeParams = SearchParameters(term: "Jibberish", states: ["Alabama", "Colorado"], earliestDayMonthYear: SearchConstants.earliestPossibleDayMonthYear, latestDayMonthYear: SearchConstants.latestPossibleDayMonthYear)
        subject.startSearch(activeParams, page: 2, contextID: "context") { _, _ in }
        let inactiveParams = SearchParameters(term: "Jabberish", states: ["Alabama", "Colorado"], earliestDayMonthYear: SearchConstants.earliestPossibleDayMonthYear, latestDayMonthYear: SearchConstants.latestPossibleDayMonthYear)
    ...
    func testThat_whenTheSpecifiedSearchIsNotActive_isSearchInProgress_returnsFalse() {
        let activeParams = SearchParameters(term: "Jibberish", states: ["Alabama", "Colorado"], earliestDayMonthYear: SearchConstants.earliestPossibleDayMonthYear, latestDayMonthYear: SearchConstants.latestPossibleDayMonthYear)
        subject.startSearch(activeParams, page: 2, contextID: "context") { _, _ in }
        let inactiveParams = SearchParameters(term: "Jibberish", states: ["Alabama"], earliestDayMonthYear: SearchConstants.earliestPossibleDayMonthYear, latestDayMonthYear: SearchConstants.latestPossibleDayMonthYear)
